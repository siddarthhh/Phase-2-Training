    ...
    public partial class DBSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Hotels",
                columns: new[] { "HotelId", "HotelDescription", "HotelName", "HotelType" },
                values: new object[] { 1, "Beach view Hotel", "Dhanapal Lodge", "5 star" });

            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "RoomId", "HotelId", "RoomName", "RoomPrice", "RoomType" },
                values: new object[] { 1, 1, "A401", 10000m, "AC Double bedroom" });
